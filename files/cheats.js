...
function activateNuclear(){
  if(gameOver)return;
  document.getElementById('board').style.filter='brightness(3) sepia(1) hue-rotate(-20deg)';
  setTimeout(()=>{
    document.getElementById('board').style.filter='';
    // NEW6: nuclear hits ALL quadrants - remove all non-king pieces of opponent across full board
